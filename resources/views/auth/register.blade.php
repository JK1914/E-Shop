...
<div class="col-md-8">
                        <div class="card">
                            ...
                            <form method="POST" action="{{route('register')}}" aria-label="Register">
                                    ...
                                    <div class="form-group row">
                                        <label for="password" class="col-sm-4 col-form-label text-md-right">E-mail</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="password-confirm" class="col-sm-4 col-form-label text-md-right">Подтвердите пароль</label>
                                        <div class="col-md-6">
